...
export default function Header() {
    const { cartItems, isCartVisible, toggleCart, setIsCartVisible, removeItem } = useContext(CartContext);
    ...
    return (
        <header style={{ display: "flex", justifyContent: "space-between", alignItems: "center", padding: "0 20px", backgroundColor: "white" }}>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: "20px" }}>
                <div
                    style={{ backgroundColor: "#BFD4E4", padding: "4px 6px", borderRadius: "8px", cursor: "pointer" }}
                    onClick={toggleCart}
                    role="button"
                ...
                <Languages />
                <div onClick={toggleMenu} style={{ cursor: "pointer" }} role="button" aria-label="Toggle menu">
